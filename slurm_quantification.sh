...
featureCounts -T 8 -p --countReadPairs  -t exon -g gene_id -a /project/bras5846/linux/2_genome/GRC38/Mus_musculus.GRCm38.102.gtf.gz \
-o counts.txt -s 2 ../3_MappingQC/aln-pe_sorted.bam 
